...
namespace MySQL.ForExcel
{
  public partial class AutoStyleableBaseForm : Form
  {
    ...
    bool InheritSystemFontToControls { get; set; }
    ...
    List<string> InheritFontToControlsList { get; set; }

    [Category("Appearance"), Description("List of control names that should NOT inherit the System Font.")]
    List<string> InheritFontToControlsExceptionList { get; set; }
    ...
    public AutoStyleableBaseForm()
    {
      ...
      InheritFontToControlsList = null;
      InheritFontToControlsExceptionList = null;
    }

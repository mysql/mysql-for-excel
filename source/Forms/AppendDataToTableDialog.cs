...
namespace MySQL.ForExcel
{
  public partial class AppendDataToTableDialog : Form
  {
    ...
    public AppendDataToTableDialog(MySqlWorkbenchConnection wbConnection, Excel.Range exportDataRange, DBObject importDBObject)
    {
      ...
      Text = String.Format("Append Data to Table (Range: {0})", exportDataRange.Address);
      lblToTable.Text = String.Format("To Table: {0}", importDBObject.Name);
    ...
    private void refreshMappedColumnsLabel()
    {
      ...
      lblMappedColumns.Text = String.Format("Mapped Columns: {0}", mappedColsCount);

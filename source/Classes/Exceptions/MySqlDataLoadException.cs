...
{
  /// <summary>
  /// Represents an error during the data loading operation of a <see cref="MySqlDataTable"/>.
  /// </summary>
  public class MySqlDataLoadException : Exception
  {
    /// <summary>
    ...
    public MySqlDataLoadException(string message, Exception innerException)
    ...
    /// </summary>
    /// <param name="innerException">The exception that is the cause of the current exception, or a null reference if no inner exception is specified.</param>
    public MySqlDataLoadException(Exception innerException)
      : this(MySqlDataTable.DataOperationType.Export, innerException)
    {
    }
  }
}
